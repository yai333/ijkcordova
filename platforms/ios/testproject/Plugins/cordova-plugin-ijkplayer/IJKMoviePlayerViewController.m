...
- (void)viewDidLoad
{
    ...
    //CGRect new_frame = self.mediaControl.topPanel.bounds;
    //new_frame.origin.y -= 100.0f;
    //self.mediaControl.topPanel.bounds =new_frame;
    //CGRect bounds = [self currentScreenBoundsDependOnOrientation];
    //self.mediaControl.frame = CGRectMake(0.0f, 0.0f,300,44);
